	...
	<div class="row">
			...
			<table class="table table-responsive table-break-medium table-striped mb-3">
				<thead>
					<tr class="text-small">
						...
						<th class="text-md-right text-sm-left">Product</th>
						<th class="text-md-right text-sm-left">Dependencies</th>
						<th class="text-md-right text-sm-left">Workload</th>
        ...
        for ($i = 0; $i <= 21; $i += 1) {
          echo '
					<tr>
						<td data-th="Factory">
							<div class="resources-factories-' .($i+1). '"></div> <span id="factories-name-' .$i. '"></span>
						</td>
						...
						<td class="text-md-right text-sm-left" data-th="Product">
							<span id="factories-product-' .$i. '"></span> <span class="resources-product-' .($i+1). '"></span>
						</td>
