<form class="mb-3" id="password-change-form" method="POST" action="api/changePassword.php">
    ...
    <div class="form-group">
        <label class="text-success">
            <strong><?php echo file_get_contents("assets/img/icons/security.svg"); ?> Change password</strong>
        </label>
...
<form class="mb-3" id="account-deletion-form" method="POST" action="api/deleteAccount.php">
    ...
    <div class="form-group">
        <label class="text-success">
            <strong><?php echo file_get_contents("assets/img/icons/delete.svg"); ?> Delete account</strong>
        </label>
