<div class="col bg-light mb-3 mt-3 p-4" id="module-registrationlogin">
    ...
    <div id="registration-accordion" role="tablist" aria-multiselectable="true" class="col">
        ...
        <div class="card-header bg-dark" role="tab" id="headingOne">
            <h5 class="mb-0">
                <a data-toggle="collapse" data-parent="#registration-accordion" href="#collapse-registration" aria-expanded="true" aria-controls="collapse-registration">Registration</a>
            </h5>
        </div>
        ...
        <div id="collapse-registration" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
            ...
            require_once "app/pages/registrationLogin/registrationForm.php";
        ...
        <div class="card-header bg-dark" role="tab" id="headingTwo">
            <h5 class="mb-0">
            <a class="collapsed" data-toggle="collapse" data-parent="#registration-accordion" href="#collapse-login" aria-expanded="false" aria-controls="collapse-login">Login</a>
            </h5>
        </div>
        <div id="collapse-login" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
            ...
            require_once "app/pages/registrationLogin/loginForm.php";
