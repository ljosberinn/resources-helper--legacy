...
<table class="table table-responsive table-break-medium mb-3">
    ...
    <tfoot>
    <tr class="small">
        <td colspan="3" class="<?= $textOrientation ?>" id="defenselog-simple-sum"></td>
        <td class="<?= $textOrientation ?>" id="defenselog-simple-win"></td>
        <td class="<?= $textOrientation ?>" id="defenselog-simple-loss"></td>
        <td class="<?= $textOrientation ?>" id="defenselog-simple-factor"></td>
        <td colspan="2" class="<?= $textOrientation ?>" id="defenselog-simple-profit"></td>
    </tr>
    </tfoot>
</table>
