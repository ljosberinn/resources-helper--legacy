...
<div class="row">
  ...
  <figure class="figure col-md-8 col-sm-12">
    ...
    <figcaption id="techupgrade-figcaption" class="figure-caption">Imagine you messed up teching a mine. This shows you possible <strong class="text-warning">remaining</strong> combinations to reach a boost factor higher than 5.0 depending on its current boost factor.</figcaption>
  </figure>
