...
<div class="bg-light mt-3 mb-3 p-4 col-12 rounded" id="module-headquarter">
    ...
    <h6><span class="nav-icon-headquarter"></span> <span id="hq-header">Headquarter</span></h6>
    <hr class="mb-3">
    ...
    <div id="headquarter-accordion" role="tablist" aria-multiselectable="true" class="col">
        <div class="card">
            <div class="card-header bg-dark" role="tab" id="heading-hq-1">
                <h5 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" data-parent="#headquarter-accordion" href="#collapse-headquarter-info" aria-expanded="false" aria-controls="collapse-headquarter-info" id="hq-personal-header">
        ...
        <div class="card">
            <div class="card-header bg-dark" role="tab" id="heading-hq-2">
                <h5 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" data-parent="#headquarter-accordion" href="#collapse-headquarter-ovw" aria-expanded="true" aria-controls="collapse-headquarter-ovw" id="hq-general-header">
