  ...
  <div id="techupgrades-accordion" role="tablist" aria-multiselectable="true" class="col">
    <div class="card">
      <div class="card-header bg-dark" role="tab" id="heading-tu-1">
        <h5 class="mb-0">
          <a class="collapsed" data-toggle="collapse" data-parent="#techupgrades-accordion" href="#collapse-techupgrades-calc" aria-expanded="false" aria-controls="collapse-techupgrades-calc" id="techupgrades-header-0">
    ...
    <div class="card">
      <div class="card-header bg-dark" role="tab" id="heading-tu-2">
        <h5 class="mb-0">
          <a class="collapsed" data-toggle="collapse" data-parent="#techupgrades-accordion" href="#collapse-techupgrades" aria-expanded="true" aria-controls="collapse-techupgrades" id="techupgrades-header-1">
