...
<div class="bg-light mt-3 mb-3 p-4 col-12 rounded" id="module-qualitycomparator">
    ...
    <h6><span class="nav-icon-qualitycomparator"></span> <span id="qualitycomparator-header">Quality Comparator</span></h6>
    <hr class="mb-3">
    ...
    <div class="row justify-content-center">
        <div class="col-xs-6 col-md-6">
            ...
            <table class="table table-responsive table-break-medium table-striped">
                <thead>
                <tr class="small">
                    <th id="qc-th-0">Type</th>
                    <th id="qc-th-1" class="text-center">Quality</th>
                    <th id="qc-th-2" class="text-right">Income/hour</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td data-th="Type / Quality / Income/hour" colspan="3">
                        <div class="input-group">
                            <select class="custom-select input-group-addon" id="qualitycomparator-selector">
                                <option selected disabled id="qc-select-txt">select resource</option>
