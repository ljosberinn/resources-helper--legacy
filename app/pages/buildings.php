    ...
    <table class="table table-break-medium table-striped mb-3">
      ...
      <tbody>
        <tr>
          ...
          <td class="' .$textOrientation. '"><small class="text-danger">Transportation</small></td>
        </tr>
        <tr>
          ...
          <td data-th="Transportation" class="' .$textOrientation. ' small"><small class="text-danger" id="buildings-transportation-1-' .$i. '"></small></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-th="Transportation" class="' .$textOrientation. ' small"><small class="text-danger" id="buildings-transportation-3-' .$i. '"></small></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td data-th="Total cost" class="' .$textOrientation. '" colspan="3" id="buildings-sum-' . $i. '"></td>
          <td data-th="Total transportation" class="' .$textOrientation. ' small"><small class="text-danger" id="buildings-transportation-sum-' . $i. '"></small></td>
        </tr>
        <tr>
          <td data-th="Remaining cost" colspan="2" class="' .$textOrientation. '"><small>to level 10:</small></td>
          <td class="' .$textOrientation. '"><small id="buildings-cap-' .$i. '"></small></td>
          <td data-th="Remaining transportation to 10" class="' .$textOrientation. '"><small class="text-danger" id="buildings-transportation-cap-' .$i. '"></small></td>
        </tr>
      </tfoot>
    </table>
  </div>';
