    ...
    <div id="maps-accordion" role="tablist" aria-multiselectable="true" class="col">
        <div class="card">
            ...
            <div id="collapse-personal-map" class="collapse" role="tabpanel" aria-labelledby="heading-map-1">
                ...
                if(isset($_SESSION["id"])) {
                    ...
                    require "app/pages/maps/personalmap.php";
        ...
        <div class="card">
            <div class="card-header bg-dark" role="tab" id="heading-map-2">
                <h5 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" data-parent="#maps-accordion" href="#collapse-world-map" aria-expanded="true" aria-controls="collapse-world-map" id="worldmap-create">World Map</a>
                </h5>
            </div>
