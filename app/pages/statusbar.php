...
<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 p-4" id="statusbar">
    ...
    <div class="row">
        <div class="col text-right mt-1">
            ...
            <a href="#settings" onclick="return false;" class="btn btn-secondary" id="settings-toggler"><span><?php echo file_get_contents('assets/img/icons/gear.svg'); ?></span> <span id="statusbar-settings">Settings</span></a> <a href="?logout"
